...
public class GenerickaKonstanta extends Konstanta {
    public KonstantaEnum konstantaTip;

    public GenerickaKonstanta(KonstantaEnum tip, int lineN, String vrijednost) {
    ...
    // actually useful
    public GenerickaKonstanta(String tip, int lineN, String vrijednost) {
        switch (tip) {
            case "IDN":
